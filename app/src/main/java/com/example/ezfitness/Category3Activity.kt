...
class Category3Activity : AppCompatActivity() {
    ...
    private val meals = listOf(
        Meal("Kung Pao Chicken", 320, 25, 15, 12),
        Meal("Sweet and Sour Pork", 380, 20, 18, 30),
        Meal("Beef Chow Mein", 450, 30, 20, 35),
        Meal("Spring Rolls", 200, 5, 10, 25)
    )
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<TextView>(R.id.textViewCategoryTitle).text = "Chinese Cuisine"
