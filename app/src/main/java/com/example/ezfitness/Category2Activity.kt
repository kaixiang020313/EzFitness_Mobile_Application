...
class Category2Activity : AppCompatActivity() {
    ...
    private val meals = listOf(
        Meal("Big Mac", 540, 25, 28, 46),
        Meal("McChicken", 400, 14, 23, 37),
        Meal("Filet-O-Fish", 410, 15, 20, 38),
        Meal("McNuggets (10 piece)", 470, 24, 30, 24)
    )
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<TextView>(R.id.textViewCategoryTitle).text = "McDonald Meal"
