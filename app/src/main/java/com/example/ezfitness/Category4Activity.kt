...
class Category4Activity : AppCompatActivity() {
    ...
    private val meals = listOf(
        Meal("Nasi Lemak", 450, 10, 25, 40),
        Meal("Rendang", 380, 20, 15, 30),
        Meal("Satay", 300, 15, 10, 25),
        Meal("Mee Goreng Mamak", 420, 12, 8, 35)
    )
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<TextView>(R.id.textViewCategoryTitle).text = "Malay Cuisine"
