...
class Category1Activity : AppCompatActivity() {
    ...
    private val meals = listOf(
        Meal("Nasi Goreng", 300, 15, 10, 40),
        Meal("Roti Canai", 250, 5, 8, 30),
        Meal("Mee Goreng", 320, 12, 9, 45),
        Meal("Teh Tarik", 100, 1, 5, 20)
    )
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<TextView>(R.id.textViewCategoryTitle).text = "Mamak Cuisine"
